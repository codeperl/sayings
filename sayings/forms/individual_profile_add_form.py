...
class IndividualProfileAddForm(ModelForm):
    """
    Individual profile from with wtforms-alchemy integration and implementation.
    """

    class Meta:
        only = ['name', 'content', 'published_at']
        csrf = True
    ...
    submit = SubmitField('Add Individual Profile')